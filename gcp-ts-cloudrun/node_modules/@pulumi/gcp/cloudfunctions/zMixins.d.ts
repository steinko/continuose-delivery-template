 ...
 */
export declare type Callback<D, C extends Context, R> = (data: D, context: C, callback: (error?: any, result?: R) => void) => Promise<R> | void;
/**
 ...
 */
export declare type CallbackFactory<D, C extends Context, R> = () => Callback<D, C, R>;
/**
 ...
 * for more details.
 */
export declare class CallbackFunction extends pulumi.ComponentResource {
    /**
 ...
 */
export declare class HttpCallbackFunction extends CallbackFunction {
    /**
 ...
 */
export declare type HttpCallback = (req: express.Request, res: express.Response) => void;
export declare type HttpCallbackFactory = () => HttpCallback;
/**
