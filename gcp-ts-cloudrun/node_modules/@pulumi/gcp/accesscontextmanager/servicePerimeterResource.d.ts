 ...
 * ```
 */
export declare class ServicePerimeterResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicePerimeterResourceState, opts?: pulumi.CustomResourceOptions): ServicePerimeterResource;
    /**
     * Returns true if the given object is an instance of ServicePerimeterResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServicePerimeterResource;
    /**
     * The name of the Service Perimeter to add this resource to.
     */
    readonly perimeterName: pulumi.Output<string>;
    /**
