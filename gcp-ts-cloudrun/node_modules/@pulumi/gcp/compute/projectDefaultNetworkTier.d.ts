 ...
 * ```
 */
export declare class ProjectDefaultNetworkTier extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectDefaultNetworkTierState, opts?: pulumi.CustomResourceOptions): ProjectDefaultNetworkTier;
    /**
     ...
     */
    static isInstance(obj: any): obj is ProjectDefaultNetworkTier;
    /**
