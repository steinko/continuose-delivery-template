 ...
 */
export declare class AuthorityIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorityIamPolicyState, opts?: pulumi.CustomResourceOptions): AuthorityIamPolicy;
    /**
     * Returns true if the given object is an instance of AuthorityIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthorityIamPolicy;
