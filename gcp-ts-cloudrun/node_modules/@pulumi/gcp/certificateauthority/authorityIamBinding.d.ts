 ...
 */
export declare class AuthorityIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthorityIamBindingState, opts?: pulumi.CustomResourceOptions): AuthorityIamBinding;
    /**
     * Returns true if the given object is an instance of AuthorityIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthorityIamBinding;
    readonly certificateAuthority: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.certificateauthority.AuthorityIamBindingCondition | undefined>;
    /**
